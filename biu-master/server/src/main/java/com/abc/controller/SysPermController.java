 ...
 */
@PermInfo(value = "系统权限模块")  //自定义权限注解 value权限名称 pval权限值
@RequiresPermissions("a:sys:perm")  //shiro自带的权限注解的使用 默认为权限值
@RestController
...
public class SysPermController {
     ...
     */
    @PermInfo("查询出所有的权限信息")
    @RequiresPermissions("a:perm:all:query")  //添加了注解，需要有权限才能调用！！！
    @GetMapping("/list/all")
    ...
    /**
     * 通过父级权限值查询出所有子级按钮权限值  TODO
     * @return
     */
    @PermInfo("查询出按钮权限信息")
    @RequiresPermissions("a:perm:button:query")  //添加了注解，需要有权限才能调用！！！
     ...
     */
    @PermInfo("查询出菜单权限信息")
    @RequiresPermissions("a:perm:menu:query")
     ...
     */
    @PermInfo("查询出接口权限信息")
    @RequiresPermissions("a:perm:api:query")
    ...
    @PermInfo("删除权限")
    @RequiresPermissions("a:perm:delete")
    ...
    @PermInfo("修改权限")
    @RequiresPermissions("a:perm:update")  //添加了注解，需要有权限才能调用！！！
    @PatchMapping("/update")
     ...
     * @return
     */
    @PermInfo("查询接口权限元数据信息")
    @RequiresPermissions("a:perm:meta:api")
    @GetMapping("/meta/api")
