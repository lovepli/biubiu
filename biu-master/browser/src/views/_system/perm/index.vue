    ...
    <el-row :gutter="20">
      ...
      <el-col :span="8">
        <el-card class="box-card">
          <div slot="header">
            <div class="title-box">
              ...
              <el-tooltip content="同步菜单权限数据" placement="top">
                <el-button style="font-size: 25px;" type="text" @click="handleSyncMenuPermissionData" icon="el-icon-refresh" v-perm="'b:perm:menu'" circle></el-button>
              </el-tooltip>
            </div>
          ...
          <el-input class="mgb-15" :placeholder="filterPlaceholderText" v-model="filterMenuPermText" v-perm="'b:perm:like'"></el-input>
      ...
      <el-col :span="8">
        <el-card class="box-card">
          ...
          <el-input class="mgb-15" :placeholder="filterPlaceholderText" v-model="filterButtonPermText" v-perm="'b:perm:like'"></el-input>
          <el-tree ref="buttonPermTreeRef" :filter-node-method="filterNode" :data="buttonPermissionTree"
            ...
            <span class="custom-tree-node" slot-scope="{ node, data }">
                ...
                <el-tooltip v-if="data.ptype==permType.MENU" style="margin-right: 80px;" content="添加按钮权限" placement="top">
                  <el-button type="text" size="mini" icon="el-icon-plus" @click="handleAddButton(data)" v-perm="'b:perm:add'"></el-button>
                </el-tooltip>
                <span v-if="data.ptype==permType.BUTTON">
                  <el-tooltip content="更新" placement="top">
                    <el-button class="update-btn" type="text" size="mini" icon="el-icon-edit" @click="handleUpdateButton(data)" v-perm="'b:perm:update'"></el-button>
                  </el-tooltip>
                  <el-tooltip content="删除" placement="top">
                    <el-button class="delete-btn" type="text" size="mini" icon="el-icon-delete" @click="handleDeleleButton(data)" v-perm="'b:perm:delete'"></el-button>
                  </el-tooltip>
                </span>
            </span>
          </el-tree>
      ...
      <el-col :span="8">
        <el-card class="box-card">
          <div slot="header">
            <div class="title-box">
              ...
              <el-tooltip content="同步接口权限数据" placement="top">
                <el-button style="font-size: 25px;" type="text" @click="handleSyncApiPermissionData" icon="el-icon-refresh" v-perm="'b:perm:api'" circle></el-button>
              </el-tooltip>
            </div>
          ...
          <el-input class="mgb-15" :placeholder="filterPlaceholderText" v-model="filterApiPermText" v-perm="'b:perm:like'"></el-input>
